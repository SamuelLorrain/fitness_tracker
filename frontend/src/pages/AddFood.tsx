...
const AddFoodForm: React.FC = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      serving_name: Yup.string().required("A serving name must be provided"),
  ...
  return (
    <form onSubmit={formik.handleSubmit}>
      ...
      <IonInput
        ...
        onIonChange={(e) =>
          formik.setFieldValue("serving_name", e.detail.value)
        }
      ...
      <IonInput
        ...
        onIonChange={(e) =>
          formik.setFieldValue("serving_weight", e.detail.value)
        }

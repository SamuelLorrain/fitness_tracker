...
class FoodRepository(Protocol):
    ...
    ) -> Generator[Food, None, None]: ...  # pragma: no cover

    def store_food(
        self, user_uuid: FoodUserUUID, food_va: FoodVA
    ) -> FoodUUID: ...  # pragma: no cover

    def get_food(
        self, user_uuid: FoodUserUUID, food_uuid: FoodUUID
    ...
    def get_food_by_barcode(
        self, user_uuid: FoodUserUUID, barcode_value: str
    ) -> Food: ...  # pragma: no cover
